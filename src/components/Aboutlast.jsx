  ...
  return (
    ...
    <div className='xl:px-24 xl:py-32 py-20 bg-black text-white'>
        <div className='xl:px-14  '>
            <h1 className='text-center sm:text-3xl xl:text-4xl xl:p-16 py-9'>Don't wait! Enroll in Apfel Academy's expert-led English courses today and improve your communication skills</h1>
